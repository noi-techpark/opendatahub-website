...
images:
  - "/img/use-cases/dexdot_ai/open-data-hub-stratgeic-partner-dexdot.jpg"

seo:
  title: "Dexdot AI & Open Data Hub – Tourism Data for AI"
  description: "See how Dexdot AI uses Open Data Hub tourism datasets to build AI-powered chatbots, analytics and data-driven solutions for tourism businesses."
  keywords:

short:
  subtitle: "DEXDOT AI"
  title: "**When artificial intelligence meets the right data**"
  description: "Open Data creates opportunities for innovation far beyond traditional reporting and analysis. Dexdot AI demonstrates how tourism datasets can become the foundation for practical AI applications that support smarter decisions and more efficient operations."
  buttons:
    - btn_link: "/use-cases/dexdot-ai"
      btn_label: Read more
  img_back: "/img/use-cases/dexdot_ai/open-data-hub-stratgeic-partner-dexdot-web.jpg"
  img_link: "/use-cases/dexdot-ai"
  img_credit: 
...
paragraphs:
  ...
  - description: "<p>The collaboration with Open Data Hub enables Dexdot AI to develop and deploy solutions more quickly while reducing technical complexity and operational costs. Ready-to-use datasets eliminate the need for custom data infrastructures and provide a reliable basis for data-driven decision-making.<p>As a result, businesses gain access to AI-powered tools that improve efficiency, support better decisions, and enhance customer experiences without having to invest in their own data management systems.<p>"
    ...
    img_back_alt: "AI tourism chatbot on a smartphone, illustrating how reliable Open Data Hub datasets can support digital guest services."
    partial: imgs-text-enlargeable.html
  ...
  - description: "<p>If you are looking to develop data-driven services, automate processes, or build new digital solutions, explore the possibilities offered by Open Data Hub. Access reliable datasets, reduce development effort and turn data into meaningful applications for your organisation.</p>"
    ...
    img_back: "/img/use-cases/dexdot_ai/open-data-hub-data-for-digital-AI-solutions.jpg"
    img_credit: "©Open Data Hub"
    img_back_title: "Open Data Hub – Data for Digital AI Solutions"
    img_back_alt: "Open Data Hub branding representing reliable data infrastructure for developing AI-powered and data-driven digital solutions."
    partial: text-imgs-enlargeable.html
