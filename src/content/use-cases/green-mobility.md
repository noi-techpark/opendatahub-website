...
start:
  ...
  title: "**Real-time e-charging stations**"
  subtitle: "An **interactive map** that shows a large set of e-charging stations together with important **real-time information**, based on **real-time open data** provided by the **Open Data Hub**."
  img_back: "/img/use-cases/green_mobility/ODH-usecase-GREENMOBILITY-image-01.jpg"
...
paragraphs:
  - description: "This map brings together an extensive network of electric vehicle charging stations from various suppliers and is an important step towards making e-mobility more accessible. This solution shows how mobility data spaces and open data integration can make green mobility infrastructure more accessible."
