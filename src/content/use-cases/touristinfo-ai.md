...
images:
  - "/img/use-cases/touristinfo-ai/open-data-hub-tourist-info-ai-landscape-social.jpg"

seo:
  title: "TOURISTINFO.AI | AI & Open Data Solutions for Tourism"
  description: "Discover TOURISTINFO.AI: AI-powered assistant for sustainable tourism using real-time datasets, tourism datasets and Open Data Hub solutions."
  keywords:

short:
  subtitle: "TOURISTINFO.AI"
  title: "**AI-powered sustainable destination management**"
  description: "Touristinfo.ai is an AI-driven virtual assistant that enables destinations and tourist offices to manage tourist flows efficiently. It also engages with guests in their own language, providing information to improve the visitor experience."
...
start:
  ...
  img_back: "/img/use-cases/touristinfo-ai/open-data-hub-tourist-info-ai-mediatize.jpg"
  img_credit: "© Touristinfo.ai"
  img_back_alt: "Photo of the startup team behind TOURISTINFO.AI, an AI-powered assistant for sustainable tourism management using Open Data Hub datasets."
  img_back_title: "TOURISTINFO.AI – Startup Team Developing AI Tourism"
...
paragraphs:
  - description: "Designed with a multichannel and multilingual approach, the service is available 24/7 and can interact in more than 80 languages. Through real-time, data-driven recommendations, it helps visitors plan their journey by suggesting public transport routes, identifying refill points and pointing to less crowded alternatives to popular attractions. Content is fully customisable, enabling destinations and hotels to update responses in line with their values and sustainability principles. A network of interconnected chatbots further ensures access to verified information across multiple destinations, while instant onboarding makes it effortless to start: a simple QR code opens the chat directly on WhatsApp."
    ...
    target_blank: true
    btn_label: More info
    img_back: "/img/use-cases/touristinfo-ai/open-data-hub-tourist-info-ai-travel-assistance.jpg"
    img_credit: " © Touristinfo.ai"
    img_back_title: "TOURISTINFO.AI – Multilingual Chatbot for Tourism"
  ...
  - description: "Open Data Hub provides Touristinfo.ai with access to essential mobility and traffic datasets, including public transport  schedules and availability, parking information with live traffic conditions, weather and cable cars data, to support service planning and hotspot management. It connects traditionally perceived public stakeholders (such as provincial authorities for weather or public transport) as well as strong consortia and private partners (such as Dolomiti Superski). These integrations allow Touristinfo.ai to deliver accurate, timely and actionable recommendations, enhancing the visitor experience while contributing to sustainable tourism management."
    ...
    img_credit: "© Open Data Hub"
    img_back_title: "Open Data Hub – Developing Digital Data Solutions"
  ...
  - description: "The implementation in San Vigilio di Marebbe (https://www.sanvigilio.com/it) shows how Touristinfo.ai can be customised to local contexts: the chatbot “Giggo”, inspired by a local symbol, offers real-time guidance on activities, pet-friendly facilities and route planning. Built on reliable datasets, the system helps distribute visitor flows more evenly, easing overtourism, improving the efficiency of tourist offices and strengthening communication between destinations, hotels and guests.<br>
    ...
    **Use Open Data Hub to build your next project.**"
    ...
    img_credit: "© Touristinffo.ai"
    img_back_title: "TOURISTINFO.AI – Presentation with San Vigilio Example"
    img_back_alt: "Photo of a TOURISTINFO.AI presentation using San Vigilio di Marebbe as an example to demonstrate the chatbot for sustainable tourism services."
    partial: imgs-text-enlargeable.html

  - description: "Open Data Hub is much more than a portal: it is a gateway to a culture of openness and collaboration.<br>
    A culture that has placed collaboration at its very core, understanding that openness and sharing generate tangible benefits for everyone, today and, above all, in the long run.<br>
    Open Data Hub means creating opportunities for those who may lack resources but have great ideas. It is a project born of conceptual maturity, one that values collective intelligence and translates into shared benefits for the entire community."
    title: "Julian Palmarin"
    subtitle: "Co-founder, touristinfo.ai"
    partial: quote.html
---